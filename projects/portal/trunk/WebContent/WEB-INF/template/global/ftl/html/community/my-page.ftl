							...
							<div class="ibox float-e-margins">
			                    <div class="ibox-title">
									...
									<div class="ibox-tools m-r-lg" data-bind="invisible:editable">
										<button class="btn btn-deafult btn-flat btn-outline btn-sm rounded" data-bind="click:exportPdf" data-loading-text="<i class='fa fa-spinner fa-spin'></i>"><i class="fa fa-file-pdf-o"></i> PDF</button>
									</div>
