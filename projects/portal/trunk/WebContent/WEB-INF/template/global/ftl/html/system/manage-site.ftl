							...
							<div class="row">
								<div class="col-lg-5 col-xs-12" id="company-info">					
									<div class="page-header page-nounderline-header text-primary">
										<h5 >
											<small><i class="fa fa-info"></i> 상세보기 버튼을 클릭하면 회사가 보유한 미디어(이미지, 파일 등)을 관리할 수 있습니다.</small>
											<button type="button" class="btn btn-primary btn-control-group btn-sm" data-toggle="button" data-action="details"> 회사 미디어 관리</button>
										</h5>
									</div>											
