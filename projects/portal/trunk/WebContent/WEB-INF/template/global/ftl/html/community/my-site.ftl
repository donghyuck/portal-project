				...
				<div class="personalized-section-content animated arrow-up">	
					<div class="container" style="min-height:450px;">						
						<div id="my-site-menu" class="bg-slivergray rounded-2x margin-top-20 website-details" style="display:none;">
							<div class="row p-sm">
								<div class="col-sm-12">
									<h2><span data-bind="text:website.menu.title"></span>   <small data-bind="text:website.menu.name"></small></h2>
									...
									<div id="template-editor" class="panel panel-default animated fadeIn" data-bind="visible: visible" style="display:none;">
										...
										<div class="panel-body padding-sm">	
											<div class="pull-right">
												<button class="btn btn-success btn-xs rounded" data-bind="visible: supportSvn, click:openFileUpdateModal" style="display:none;" ><i class="fa fa-long-arrow-down"></i> 업데이트</button>
												<button class="btn btn-danger btn-xs rounded" data-bind="visible: supportCustomized, click:openFileCopyModal" style="display:none;"><i class="fa fa-code"></i> 커스텀 템플릿 만들기</button>
											</div>												
										</div>
