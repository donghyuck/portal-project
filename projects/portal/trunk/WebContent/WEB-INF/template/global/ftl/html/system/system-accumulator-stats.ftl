			...
			if(! common.ui.exists(renderTo) ){
				common.ui.grid(renderTo, {
					...
					columns: [
						...
						{ title: "UPDATE DATE", field: "lastValueDate", width:200, headerAttributes: { "class": "table-header-cell", style: "text-align: center" } , template: "#= kendo.toString( lastValueDate, 'yyyy.MM.dd')#"}
					],
