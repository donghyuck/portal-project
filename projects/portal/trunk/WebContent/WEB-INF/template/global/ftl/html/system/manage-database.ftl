					...
					<div class="col-sm-8">										
						<div id="database-table-details" class="panel panel-primary" data-bind="visible:visible">
							...
							<div data-role="grid" 
								...
								data-columns="[ {'field':'primaryKey', 'title':'기본키', 'template':'<i class=\\"fa fa-key\\"></i> #: primaryKey#' }, {'field':'name', 'title':'컬럼'}, {'field':'typeName' ,'title':'타입'}, {'field':'size' ,'title':'크기'}, {'field':'nullable' ,'title':'IS_NULLABLE'}]"  class="no-border" ></div>
