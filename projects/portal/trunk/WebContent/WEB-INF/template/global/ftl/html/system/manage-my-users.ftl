			...
			if( ! renderTo4.data("kendoGrid") ){	
					renderTo4.kendoGrid({
						...
						columns: [
							...
							{ field: "ownership", title: "권한부여됨", width:100,  filterable: false, sortable: false, template:'<input type="checkbox" class="k-checkbox" #if (ownership){ #checked="checked" #}# #if (inherited){# disabled="disabled" #}#><label class="k-checkbox-label">&nbsp;</label>' }, 
						],
						dataBound:function(e){
