					...
					<div class="col-md-9">
						<div class="panel panel-default rounded no-margin-b bg-slivergray">
							...
							<div class="morphing no-padding-t">
								<button class="btn-u btn-u-red btn-u-sm rounded-buttom pull-right" type="button" data-toggle="button" data-action="morphing"><i class="fa fa-pencil fa-lg"></i> <span class="hidden-xs"> 새로운 공지 & 이벤트</span></button>
