...
<head>
	...
	<li class="item"><a href="\\#" class="thumbnail"><img src="${request.contextPath}/community/download-my-image.do?width=150&height=150&imageId=#= imageId#" alt="" class="img-thumbnail" /></a></li>
	</script>
