...
<head>
		...
		function displayPhotoPanel(){
			...
			common.ui.panel({
				...
				content: "<figure class='effect-marley'>" + "<img class='img-responsive' src='/community/download-my-image.do?imageId=" + photoPlaceHolder.imageId + "'>" + "<pigcaption><a href="\\#">View more</a></pigcaption>" + "</figure>",
				close: function(e) {
					$("#"+guid+"-layout").remove();
				}
			});
