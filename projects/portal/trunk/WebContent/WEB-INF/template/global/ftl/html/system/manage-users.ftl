            ...
            complete: function() {       
				...
				var user_grid = $("#user-grid").kendoGrid({
                    ...
                    columns: [
                        ...
                        { field: "username", title: "아이디", width: 150, headerAttributes: { "class": "table-header-cell", style: "text-align: center"}, locked: true , template: '<button type="button" class="btn btn-primary btn-xs btn-block">#: username #</a>' }, 
