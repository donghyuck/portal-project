							...
							<div id="user-list-panel" class="panel panel-default" style="min-height:300px;" >
								<div class="panel-heading">
									...
									<div class="panel-heading-controls">											
										...
										<input type="checkbox" name="panel-switcher" data-class="switcher-primary" role="switcher" >
									</div>
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="note note-danger">
							...
							<div class="text-danger padding-sm">비밀번호에 특수문자를 추가하여 사용하시면
							기억하기도 쉽고, 비밀번호 안전도가 높아져 도용의 위험이
							줄어듭니다.	
							</div>
						</div>
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-lg-7">
								<div class="has-feedback">
									<input type="password" name="password" placeholder="비밀번호" class="form-control" required validationMessage="비밀번호를 입력하여 주세요." >
						...
						<div class="form-group">
							...
							<div class="col-lg-7">
								<div class="has-feedback">
									<input type="password" name="repeat-password" placeholder="비밀번호 확인" class="form-control" required validationMessage="비밀번호를 입력하여 주세요." >
									<i class="fa fa-asterisk form-control-feedback"></i>
								</div>								
							</div>
						</div>		
