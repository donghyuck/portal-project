		...
		function createCompanyLogoGrid(renderTo, data){
			if( ! renderTo.data("kendoGrid") ){	
				renderTo.kendoGrid({
					...
					columns:[
							{ title: "&nbsp;",  width: 30, filterable: false, sortable: false, template:'<div class="text-center"><img alt="" class="img-thumbnail" src="<@spring.url "/secure/download/logo/#= logoId #?width=120&height=120" />"></div>' },
			...
			<div class="panel-body padding-sm">
				...
				<div class="tab-v1">
					<ul class="nav nav-tabs nav-tabs-xs">
						<li class=""><a href="\\#company-#= companyId#-tab-1" data-toggle="tab" data-action="logos">Home</a></li>
