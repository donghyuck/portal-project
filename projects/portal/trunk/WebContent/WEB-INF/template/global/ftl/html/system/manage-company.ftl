			...
			complete: function() {
				...
				var company_grid = $("#company-grid").kendoGrid({
					...
					columns: [
						...
						{ command: [ { text:"상세보기", click: showCompanyDetails, className:"btn btn-xs btn-info"  }, { name:"edit",  text: { edit: "수정", update: "저장", cancel: "취소"} , imageClassName:"fa fa-pencil", className:"btn btn-xs btn-danger" } ], title: "&nbsp;", width: 180  }], 
					filterable: true,
					editable: "inline",
					selectable: 'row',
					height: '350',
