			...
			if( !common.ui.exists(renderTo) ){
				if( usingDatabase ){
					common.ui.grid(renderTo, {
						...
						sortable: true,
						height:500,
						toolbar: kendo.template('<div class="btn-group p-sm"><a href="\\#"class="btn btn-primary btn-sm btn-flat btn-outline k-grid-add">추가</a><a href="\\#"class="btn btn-primary btn-sm btn-flat btn-outline k-grid-save-changes">저장</a><a href="\\#"class="btn btn-primary btn-sm btn-flat btn-outline k-grid-cancel-changes">취소</a></div><button class="btn btn-info btn-sm btn-flat btn-outline m-l-sm" data-action="refresh">새로고침</button>'),
						/*
						[
							{ name: "create", text: "추가" },
							{ name: "save", text: "저장" },
