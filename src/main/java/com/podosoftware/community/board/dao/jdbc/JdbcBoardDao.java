...
public class JdbcBoardDao extends ExtendedJdbcDaoSupport implements BoardDao {
	...
	public List<Member> getSearchMemberList(String search) {
		return getExtendedJdbcTemplate().query(getBoundSql("PORTAL_CUSTOM.SEARCH_PODO_MEMBER").getSql(), rowMapper,
	...
	static class BoardRowMapper implements RowMapper<Board> {
		...
		public Board mapRow(ResultSet rs, int rowNum) throws SQLException {
			DefaultBoard b = new DefaultBoard();
	...
	static class QnaBoardRowMapper implements RowMapper<QnaBoard> {
		...
		public QnaBoard mapRow(ResultSet rs, int rowNum) throws SQLException {
			DefaultQnaBoard q = new DefaultQnaBoard();
	...
	public List<Member> findMemberList(DataSourceRequest dataSourceRequest, int startIndex, int maxResults) {
		...
		return getExtendedJdbcTemplate().queryScrollable(
				this.getBoundSqlWithAdditionalParameter("PORTAL_CUSTOM.FIND_PODO_MEMBER", map).getSql(), startIndex,
				maxResults, new Object[] {}, new int[] {}, rowMapper);
	}
	...
	public Integer countMemberList(DataSourceRequest dataSourceRequest) {
		...
		return getExtendedJdbcTemplate().queryForObject(
				getBoundSqlWithAdditionalParameter("PORTAL_CUSTOM.COUNT_PODO_MEMBER", map).getSql(), Integer.class);
	}
	...
	public List<Long> findMemberIDs(DataSourceRequest dataSourceRequest, int startIndex, int maxResults) {
		...
		return getExtendedJdbcTemplate().queryScrollable(getBoundSql("PORTAL_CUSTOM.SELECT_PODO_MEMBER_IDS").getSql(),
	...
	public Member getMemberById(Long id) {
		...
		return getExtendedJdbcTemplate().queryForObject(getBoundSql("PORTAL_CUSTOM.SELECT_PODO_MEMBER_BY_ID").getSql(),
	...
	public Integer countBoardList(DataSourceRequest dataSourceRequest) {
		return getExtendedJdbcTemplate().queryForObject(
				getBoundSqlWithAdditionalParameter("PORTAL_CUSTOM.COUNT_BOARD", dataSourceRequest.getData()).getSql(),
				Integer.class);
	}

	/*
	 * @Override public List<Long> getBoardList(DataSourceRequest
	 * dataSourceRequest, int startIndex, int maxResults) { return
	 * getExtendedJdbcTemplate().queryScrollable(this.getBoundSql(
	 * "PORTAL_CUSTOM.GET_BOARD_LIST").getSql(), startIndex, maxResults, new
	 * Object[] { }, new int[] { }, Long.class); }
	 */
