					...
					<div id="competency-details" class="panel panel-default" style="display:none;">
						<form>
							...
							<div class="panel-body no-padding-b">	
								...
								<p class="p-sm" data-bind="{text: competency.competencyGroupCode}"></p>		
								<input id="competency-details-competency-group-dorpdown-list"
										...
										data-bind="value:competency.competencyGroupCode, source: competencyGroupDataSource, enable:editable" />											
