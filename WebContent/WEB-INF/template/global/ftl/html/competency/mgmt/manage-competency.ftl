					...
					<div id="competency-details" class="panel panel-default" style="display:none;">
						<form>
							...
							<div class="panel-body no-padding-b">	
								...
								<p class="p-sm" data-bind="{text: competencyGroupCode , visible:visible}"></p>		
										...
										data-option-label="없음"
															data-role="dropdownlist"
										                  	data-auto-bind="true"
										                   	...
										                   	data-bind="{value: competencyGroupCode, source: competencyGroupDataSource , visible:editable}" />	
