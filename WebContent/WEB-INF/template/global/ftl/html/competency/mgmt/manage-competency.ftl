					...
					<div id="competency-details" class="panel panel-default" style="display:none;">
						...
						<div class="panel-body">	
							...
							<div class="p-sm text-right">
								<button class="btn btn-default btn-flat" data-bind="visible:editable" style="display:none;">변경</button>
								<button class="btn btn-primary btn-flat btn-outline" data-bind="visible:updatable" style="display:none;">저장</button>
