		...
		<div class="wrapper">
			...
			<div class="promo-bg-img-v2 fullheight promo-bg-fixed arrow-up" style="height:350px;">
				<!--<div class="container valign__middle text-center" data-start="opacity: 1;" data-500="opacity: 0;">
					...
					<h2 class="promo-text-v2 color-light animated fadeInUp wow margin-bottom-20 visible-lg" data-wow-duration="1.5s" data-wow-delay="5s">WE ARE CREATIVE COMPANY</h2>
			...
			<div class="call-action-v2 p-md bg-white arrow-up">
				<div class="container">
					<h2 class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">역량진단은 왜 중요할까요?</h2>
					<div class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.5s">
