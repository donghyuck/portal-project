											...
											<div class="panel panel-default rounded-bottom my-announce-view"  style="display:none;">
												<div class="panel-heading">
													...
													<ul class="list-unstyled">
														...
														<li class="text-muted">
															<img width="30" height="30" class="img-circle pull-left" data-bind="attr:{src:authorPhotoUrl}" src="/images/common/no-avatar.png">
															<ul class="list-unstyled text-muted" style="padding-left:5px;">
