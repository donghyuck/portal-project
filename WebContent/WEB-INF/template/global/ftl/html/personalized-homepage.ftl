		...
		<nav class="personalized-navbar navbar" role="navigation">
			<div class="container">
				...
				<ul class="nav navbar-nav navbar-right">		
					...
					<li><a href="#" class="btn btn-link custom-nabvar-show-opt btn-control-groups" data-action="open-spmenu"><i class="fa fa-cloud fa-lg"></i></a></li>
					
					<li><a href="#" class="btn btn-link custom-nabvar-hide btn-control-group" data-action="website-setting"><i class="fa fa-briefcase fa-lg"></i></a></li>
