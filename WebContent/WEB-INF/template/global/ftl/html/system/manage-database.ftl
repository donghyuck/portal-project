			...
			common.api.callback(  
			{
				...
				success : function(response){					
					...
					if( response.taskStatusCode == 2 ){
						...
						var template = kendo.template('<li class="list-group-item"><i class="fa fa-table"></i> #= name # <button class="btn  btn-primary btn-outline btn-flat btn-xs pull-right">상세 보기</button></li>');
						$.each( 
							response.tableNames,
