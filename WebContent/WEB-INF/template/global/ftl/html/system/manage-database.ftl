				...
				<div class="row">			
					...
					<div class="col-sm-8">										
						<div id="database-table-details" class="panel panel-primary" data-bind="visible:visible">
							...
							<div data-role="grid" data-sortable="true" data-bind="source: columns" data-columns="[ {'field':'primaryKey', 'title':'기본키', 'template':' #if(primaryKey){# <i class="fa fa-key"></i>  #}# #: primaryKey #'}, {'field':'name', 'title':'컬럼'}, {'field':'typeName' ,'title':'타입'}, {'field':'size' ,'title':'크기'}, {'field':'nullable' ,'title':'IS_NULLABLE'}]"  class="no-border" ></div>
