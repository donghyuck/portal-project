		...
		function createCacheStatsGrid(){
			...
			if( !common.ui.exists(renderTo) ){
				common.ui.grid(renderTo, {
					...
					columns: [
						{ field: "cacheName", title: "Cache", width:80,  filterable: true, sortable: true , template: '#: cacheName # <button class="btn btn-xs btn-labeled btn-danger pull-right btn-selectable" data-action="cache-removeAll" data-loading-text="<i class=&quot;fa fa-spinner fa-spin&quot;></i>"><span class="btn-label icon fa fa-bolt"></span>캐쉬 비우기</button>' }, 
		...
		<div id="main-wrapper">
			...
			<div id="content-wrapper">
				<ul class="breadcrumb breadcrumb-page">
					<#assign selectedMenu = WebSiteUtils.getMenuComponent("SYSTEM_MENU", "MENU_1_6_4") />
					<li><a href="#">Home</a></li>
