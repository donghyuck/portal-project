			...
			if( ! renderTo4.data("kendoGrid") ){	
					renderTo4.kendoGrid({
						...
						columns: [
							...
							{ field: "inherited", title: "그룹", width:100,  filterable: false, sortable: false, template:'<input type="checkbox" id="eq1" class="k-checkbox" #if (inherited){ #checked="checked"#}# disabled="disabled"><label class="k-checkbox-label" for="eq1">Towbar preparation</label>' }, 
