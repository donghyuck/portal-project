		...
		<nav class="personalized-navbar navbar" role="navigation">
			<div class="container">
				...
				<ul class="nav navbar-nav navbar-right">		
					<p class="navbar-text hidden-xs">&nbsp;</p>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">마이 페이지 <b class="caret"></b></a>
						<ul class="dropdown-menu">
							...
							<li><a href="${request.contextPath}/main.do?view=manage" class="btn btn-link">마이 웹사이트</a></li>					
							</#if>								
						</ul>
					</li>
