			...
			<div class="row">
				<div class="col-sm-12">
					<div class="page-header">
						<h2>${action.targetPage.title}</h2><small class="text-muted"><i class="fa fa-quote-left fa-2x"></i> ${action.targetPage.summary!} <i class="fa fa-quote-right fa-2x"></i></small>
					</div>				
				</div>
			</div>
			<div class="row">
