...
<head>
	...
	<div class="col-sm-2 col-xs-4 margin-bottom-20" >		
		<span class="image-bg" style="background-image: url('<@spring.url '/download/image/#= imageId #/#=name#?width=150&height=150'/>');"></span>	
	</div>
	</script>		
	<!-- ./END TEMPLATE -->
	</body>    
