...
<head>
		...
		yepnope([{
			...
			'css!<@spring.url "/styles/common.ui.pages/personalized.css"/>',	
				...
				<div class="modal-content">	
					...
					<article class="summary">
						<div class="buttons-wrapper">				
							<button class="btn btn-sm btn-primary btn-labeled btn-flat btn-outline rounded" data-bind="click:commentary"><span class="btn-label icon fa fa-comment-o"></span>댓글 (<span data-bind="{ text: page.commentCount }"></span>) </button>
						</div>
