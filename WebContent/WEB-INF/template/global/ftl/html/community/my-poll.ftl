					...
					<form action="#" class="sky-form">
						<fieldset>
							...
							<section>
								...
								이러한 설정은 <a href="#" class="btn btn-default btn-flat btn-sm rounded" data-modal-settings data-toggle="collapse" data-target="#my-poll-modal-settings" area-expanded="false" aria-controls="my-poll-modal-settings" aria-expanded="false"><i class="fa fa-cog"></i> 고급옵션</a> 에서 변경할 수 있습니다.
							</section>					
						</fieldset>		
