						...
						if( this.poll.pollId > 0 ){
							...
							if (!common.ui.exists(listview)) {								
								common.ui.grid(listview, {
									...
									toolbar: kendo.template('<div class="p-xs"><div class="btn-group"><a href="\\#"class="btn btn-primary btn-flat btn-outline k-grid-add">추가</a><a href="\\#"class="btn btn-primary btn-flat btn-outline k-grid-save-changes">저장</a><a href="\\#"class="btn btn-primary  btn-flat btn-outline k-grid-cancel-changes">취소</a></div><button class="btn btn-info btn-sm btn-flat btn-outline m-l-sm pull-right" data-action="refresh">새로고침</button></div>'), 
									columns:[{
										width: 100,
					...
					<form action="#" class="sky-form">
						<fieldset>
							...
							<section>
								...
								이러한 설정은 <button type="button" class="btn btn-success btn-flat btn-sm rounded" data-modal-settings data-toggle="collapse" data-target="#my-poll-modal-settings" area-expanded="false" aria-controls="my-poll-modal-settings" aria-expanded="false"><i class="fa fa-cog"></i> 고급옵션</button> 에서 변경할 수 있습니다.
							</section>					
						</fieldset>		
