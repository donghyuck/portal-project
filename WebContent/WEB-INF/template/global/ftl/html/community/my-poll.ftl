				...
				<div class="modal-content my-page-post-form">	
					...
					<form action="#" class="sky-form">
						<fieldset>
							...
							<section>
								 설문은 <span data-format="yyyy.MM.dd" data-bind="text: poll.startDate"></span>부터 <span data-format="yyyy.MM.dd" data-bind="text: poll.endDate"></span>까지 진행되며 결과는 <span data-format="yyyy.MM.dd" data-bind="text: poll.expireDate"></span> 까지 볼수 있습니다. 이러한 설정은 고급옵션에서 변경할 수 있습니다.
							</section>					
						</fieldset>		
