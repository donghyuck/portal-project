			...
			<div class="container content">			
				...
				<div class="row">					
					<div class="col-sm-10 col-sm-offset-1">		
						...
						<ul class="text-sm m-t-md">
							<li>관리적 조치: 개인 정보 보호에 관한 직원 정기 교육 및 내부 관리 제도의 마련 및 실시, 등</li>
							<li>기술적 조치: 개인 정보 처리 시스템 등에 대한 액세스 권한 관리, 액세스 제어 시스템 설치, 고유한 식별 정보 등 체계화, 보안 프로그램 설치 등.</li>
							<li>물리적 조치: 컴퓨터실이나 데이터 저장소 등 개인 정보 저장 매체에 대한 액세스 제한.</li>
						</ul>													
					</div>
				</div>																			
			</div>							 									 			
